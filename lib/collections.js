...
module.exports = function (callback) {
  ...
  var insert = function (collections, callback) {
    ...
    db.newRegistryIngestBulkOp('archivesCollections', (bulk) => {
  ...
  db.prepareRegistryIngestArchivesCollections(function () {
    var filename = `${process.cwd()}${lexicon.configs.dataSourceFiles.archivesCollections}`
    ...
    exec(`wc -l ${filename}`, function (error, results) {
      ...
      db.returnCollectionRegistry('archivesCollections', function (err, collection) {
